...
function preload(){
  theShader = loadShader('/showcase/sketches/exercises/procedural_texturing/shaders/shader_2.vert','/showcase/sketches/exercises/procedural_texturing/shaders/shader_2.frag');
}
